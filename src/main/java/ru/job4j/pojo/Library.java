...
public class Library {
    ...
    public static Book[] swap(Book[] array, int src, int dest) {
        Book temp = new Book(array[src].getTitle(), array[src].getPageCount());
        array[src].setTitle(array[dest].getTitle());
        array[src].setPageCount(array[dest].getPageCount());
        array[dest].setTitle(temp.getTitle());
        array[dest].setPageCount(temp.getPageCount());
        return array;
    }
